...
export default function Main({ MAIN }) {
    ...
    switch (selectedMain) {
        ...
        case "WRITE_ESSAY":
            return (
                <main>
                    <img id="detalhe-fundo-redacao" src="./src/assets/detalhe-fundo.png" alt="detalhe-fundo" />
                    <div id="nav-bar-redacao">
                        <button id="icone-redacao"></button>
                        <button id="jornada-redacao">
                            Jornada
                        </button>
                        <button id="temas-redacao">
                            Temas
                        </button>
                        <img id="logo-atlas-redacao" src="./src/assets/logo-atlas.png" alt="logo-atlas"/>
                    </div>
                    <div id="card-redacao">
                    <div id="container-left-redacao">
                        <button id="back-btn" onClick={() => setSelectedMain("MAIN_MENU")}></button>
                        <img id="meninaEscrevendo" src="./src/assets/meninaEscrevendo.png" alt="Menina Escrevendo" />
                        <div id="inf-redacao">
                        <label htmlFor="theme">Qual é o tema da sua <span id="temaRoxo">redação</span>?</label>
                        <div id="text-redacao">
                            <input type="text" id="theme" placeholder="Digite aqui..."/>
                            <button id="hamburguer"></button>
                        </div>
                        <label htmlFor="model">Qual o <span id="temaRoxo">modelo de correção?</span></label>
                        <div id="model">
            ...
            return (
                <main>
                    ...
                    <div id="nav-bar-correcao-redacao">
                        ...
                        <button id="jornada-correcao-redacao">
                            Jornada
                        </button>
                        <button id="temas-correcao-redacao">
                            Temas
                        </button>
                        <img id="logo-atlas-correcao-redacao" src="./src/assets/logo-atlas.png" alt="logo-atlas"/>
                    </div>
                    ...
                    <div id="container-right-correcao-redacao">
                        ...
                        {/*
                        <p id="analiseGeralTexto">{lastEssay.General_Analysis}</p>
                        */}
                        <h2 id="pont-comp">Pontos por Competências</h2>
